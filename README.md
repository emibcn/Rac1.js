...
- Use GoogleAnalytics (integrated as a React component) for usage statistics, but respect user's DNT and don't even load it if user agent reports DNT header
